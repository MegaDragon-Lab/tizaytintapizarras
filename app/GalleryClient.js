        ...
        <div className="gallery-grid">
          ...
          {artistWa && (
            <div className="art-card custom-card" {...h}>
              ...
              <div className="card-info">
                <div className="card-text">
                  <p className="card-title">¿No encuentras lo que buscas?</p>
                  <p className="card-desc">Pídenos tu obra a medida — tamaño, diseño y colores personalizados</p>
                </div>
                <a className="btn-wa btn-wa-custom"
                  href={`https://wa.me/${artistWa.replace(/[^\d+]/g, '')}?text=${encodeURIComponent('¡Hola! Me gustaría pedir una obra a medida en Tiza & Tinta. ¿Podemos hablar?')}`}
                  target="_blank" rel="noopener"
                  onClick={e => e.stopPropagation()} {...h}>
                  <WaIcon /> Pedir a medida
                </a>
              </div>
            </div>
          )}
